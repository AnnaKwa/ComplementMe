...
@app.route('/quickdemo2')
def quick_demo2():
    predictor_set='hsv'

    input_outfit = ColorModel.outfit_input(location_type='local', location_path='static/test_selfie_2.jpg')
...
@app.route('/quickdemo3')
def quick_demo3():
    predictor_set='hsv'

    input_outfit = ColorModel.outfit_input(location_type='local', location_path='static/test_selfie_3.jpg')
